...
export const THEME_PROMPTS: Record<PosterTheme, string> = {
  ...
  [PosterTheme.INK_WASH]: 'traditional Chinese ink wash painting, black and white with subtle red accents, calligraphy style, mountain and river',
  ...
  [PosterTheme.RETRO_POP]: 'pop art style, halftone patterns, vibrant bold colors, comic book aesthetic, roy lichtenstein style, retro 80s poster, bold outlines, ben-day dots',
  [PosterTheme.CLAY_3D]: 'cute clay 3d render, soft lighting, pastel colors, plasticine texture, playful, isometric view, c4d style, blender 3d, rounded shapes',
